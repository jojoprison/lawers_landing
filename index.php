...
<link href="style.css" rel="stylesheet" type="text/css"/>    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css" integrity="sha384-JcKb8q3iqJ61gNV9KGb8thSsNjpSL0n8PARn9HuZOnIxN0hoP+VmmDGMN5t9UJ0Z" crossorigin="anonymous">
...
<body>
    ...
    <header>
      <div class="block1">
        <nav class="navbar navbar-expand-lg" style="position:fixed; padding-top: 30px; font-size:15px;">
        <a class="navbar-brand" href="#"><<!--<img src="logo.png" alt="" width="15%">--></a>
          <button class="navbar-toggler"  type="button" data-toggle="collapse" data-target="#navbarNav" 
          aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
            <span class="navbar-toggler-icon" ><svg width="1em" height="1em" style="color:white" viewBox="0 0 16 16" class="bi bi-justify" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link active" href="#">Тарифы</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="baza_znaniy.php">База знаний</a>
              </li>
              <li class="nav-item">
    ...
    <div class="block2" style="background: #1E272E; color:white;">
...
<div class="block333">
<div class="zagolovok">
<h3>РЕГЛАМЕНТЫ МЕЖДУНАРОДНОГО ФОРМАТА</h3>
  <h5>КОТОРЫЕ МЫ ИЗУЧИЛИ ОТ И ДО</h5>
  </div>
    ...
    <div class="container">
     ...
     товары не доставлены / услуги не
     оказаны / работы не выполнены"</p>
        </span>
        <span class="col-sm dot"><img src="2.png" alt="" width="40%" style="padding: 15px;">
          ...
          Dispute Reasons(продавец ввел в
          заблуждение) или Dispute Condition 13.1:
        ...
        <span class="col-sm dot"><img src="3.png" alt="" width="27%" style="padding-top: -30px;">
          <p class="p_mal">3. Chargeback Guide от 13 December 2018</br></br>
            ...
            4855 —Goods or Services Not Delivered</p>
        </span>
      </div>
</div>
</br></br>
...
<br>
     ...
     <!--<div class="block3">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-sm">
            <p class="block3_p"><img src="icons/icons/Gear-fill.svg" alt="" width="25" height="25" title="Bootstrap">  Решение проблем <br>от А до Я</p>
              <p>Мы работаем от заявки до реальных денег на Вашем счету</p>
          </div>

          <div class="col-sm">
            <p class="block3_p"><img src="icons/icons/Patch-check-fll.svg" alt="" width="25" height="25" title="Bootstrap"> Боремся до последнего цента</p>
            <p>В случае частичного оспаривания, продолжаем работать</p>
          </div>

          <div class="col-sm">
            <p class="block3_p"><img src="icons/icons/Shield-fill-check.svg" alt="" width="25" height="25" title="Bootstrap"> Конфиденциальность</p><br>
            <p>Полная конфиденциальность Ваших данных</p>
          </div>

          <div class="col-sm">
            <p class="block3_p"><img src="icons/icons/Smartwatch.svg" alt="" width="25" height="25" title="Bootstrap"> Экономим Ваше время</p><br>
  ...
  <div class="container" style="height:auto; color:white; padding-top: 100px;">
    <form>
